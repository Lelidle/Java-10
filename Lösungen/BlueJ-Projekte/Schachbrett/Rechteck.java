...
class Rechteck {
    ...
    public int mitteXGeben(){
        System.out.println(linksObenX + " " + laenge + " " + breite);
        System.out.println(linksObenX + laenge/2);
        System.out.println();
        return linksObenX + laenge/2;
    }
    
    public int mitteYGeben() {
        return linksObenY + breite/2;
    }
